...
fn num_letters(n: u64) -> u64 {
    match n {
        ...
        20..=39 | 80..=99 => 6 + match n % 10 { 0 => 0, x => num_letters(x) },
        40..=69 => 5 + match n % 10 { 0 => 0, x => num_letters(x) },
        70..=79 => 7 + match n % 10 { 0 => 0, x => num_letters(x) },

        // _ hundred and _
        100..=999 => num_letters(n / 100) + 7 + match n % 100 { 0 => 0, x => 3 + num_letters(x) },
        1000..=9999 => num_letters(n / 1000) + 8 + match n % 1000 { 0 => 0, x => num_letters(x) },
        _ => unimplemented!()
    }
}
